local function getDataLines_1393603776()
	local result =
	{
		[EFlowType.EFT_0] =
		{
...
local function getDataGrid_1393603776()
	local result = {}
...
local function getDataLevel0_4()
    
    local result =
    {
        data_grid                   = getDataGrid_1393603776(),
        data_lines                  = getDataLines_1393603776(),
