local function getDataLines_1393603751()
    local result =
    {
        [EFlowType.EFT_0] =
        {
...
local function getDataGrid_1393603751()
    local result = {}
    ...
    for rowIndex = 1, 5, 1 do
        ...
        for columnIndex = 1, 5, 1 do
            ...
            elseif(rowIndex == 3 and columnIndex == 1)then
                cellData = 
                {
                    type = ECellType.ECT_FLOW_POINT,
                    is_start = false,
...
local function getDataLevel0_3()
    
    local result =
    {
        data_grid                   = getDataGrid_1393603751(),
        data_lines                  = getDataLines_1393603751(),
