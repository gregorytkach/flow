local function getDataLines_1393603676()
    local result =
    {
        [EFlowType.EFT_0] =
        {
...
local function getDataGrid_1393603676()
    local result = {}
...
local function getDataLevel0_1()
    
    local result =
    {
        data_grid                   = getDataGrid_1393603676(),
        data_lines                  = getDataLines_1393603676(),
